...
(function () {
    ...
    // because Notion creates the page from JS, script must for elements
    ...
    function toggleSidebar() {
        ...
        if (sidebarEnable) {
            ...
            // hide the "normal" sidebar toggle
            NshowSidebarButton.parentElement.parentElement.style.width = "0px";
            NshowSidebarButton.parentElement.parentElement.style.scale = "0";
        ...
        // re-enable sidebar
            ...
            // hide the "normal" sidebar toggle
            NshowSidebarButton.parentElement.parentElement.style.width = "48px";
            NshowSidebarButton.parentElement.parentElement.style.scale = "1";
    ...
    function addToggleToDOM() {
        ...
        if (!toggleButton_exists) {
            ...
            toggleButton.style.cssText = "background-color: transparent; border: none; flex-shrink: 0; width: 48px; height: 48px; margin: -12px -6px -12px -12px; padding: 12px;"
            ...
            child ? child.insertBefore(toggleButton, child.firstChild) : Ntopbar.insertBefore(toggleButton, Ntopbar.firstChild);
